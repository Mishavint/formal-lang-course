...
class TestsForHellingsCfpq:
    def test_works_as_expected_1(self):
        ...
        res = cfpq(cfg, graph, {0}, {5}, algorithm=CfpqAlgorithms.HELLINGS)
    ...
    def test_works_as_expected_2(self):
        ...
        res = cfpq(cfg, graph, start_nodes={3}, algorithm=CfpqAlgorithms.HELLINGS)
        assert res == set()

        res = cfpq(cfg, graph, start_nodes={0}, final_nodes={2, 3}, algorithm=CfpqAlgorithms.HELLINGS)
        assert res == {(0, 2), (0, 3)}
